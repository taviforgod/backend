...
export async function list(req, res) {
  try {
    ...
    const prayers = await prayerModel.getPrayers(req.user.church_id, limit, offset);
    res.json(prayers);
  } catch (err) {
...
export async function getById(req, res) {
  try {
    const prayer = await prayerModel.getPrayerById(req.params.id, req.user.church_id);
