...
export const createTitle = async (req, res) => {
  const row = await addTitle(req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Title', action: 'created', resourceId: row?.id, name: row?.name });
};
export const editTitle = async (req, res) => {
  const row = await updateTitle(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Title', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const createGender = async (req, res) => {
  const row = await addGender(req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Gender', action: 'created', resourceId: row?.id, name: row?.name });
};
export const editGender = async (req, res) => {
  const row = await updateGender(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Gender', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const createMaritalStatus = async (req, res) => {
  const row = await addMaritalStatus(req.body.name);
  res.json(row);
...
export const editMaritalStatus = async (req, res) => {
  const row = await updateMaritalStatus(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'MaritalStatus', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const createMemberType = async (req, res) => {
  const row = await addMemberType(req.body.name);
  res.json(row);
...
export const editMemberType = async (req, res) => {
  const row = await updateMemberType(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'MemberType', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const createMemberStatus = async (req, res) => {
  const row = await addMemberStatus(req.body.name);
  res.json(row);
...
export const editMemberStatus = async (req, res) => {
  const row = await updateMemberStatus(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'MemberStatus', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const createNationality = async (req, res) => {
  const row = await addNationality(req.body.name);
  res.json(row);
...
export const editNationality = async (req, res) => {
  const row = await updateNationality(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Nationality', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const createChurch = async (req, res) => {
  const row = await addChurch(req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Church', action: 'created', resourceId: row?.id, name: row?.name });
};
export const editChurch = async (req, res) => {
  const row = await updateChurch(req.params.id, req.body.name);
  res.json(row);
  notifyLookup(req, { resource: 'Church', action: 'updated', resourceId: req.params.id, name: req.body.name });
};
...
export const getAllZones = async (req, res) => {
  ...
  res.json(await getZones(church_id));
};
export const createZone = async (req, res) => {
  const church_id = req.user?.church_id || req.body.church_id;
  if (!church_id) return res.status(400).json({ error: 'church_id required' });
  const row = await addZone({ ...req.body, church_id });
  res.json(row);
