  ...
  try {
    ...
    (async () => {
      try {
        ...
        const message = `${payload.milestone_name || 'A milestone'} was recorded for member ${payload.member_id}.`;
  ...
  try {
    ...
    (async () => {
      try {
        ...
        const message = `Milestone record ${id} was removed${memberId ? ` for member ${memberId}` : ''}.`;
