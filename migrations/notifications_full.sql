...
INSERT INTO reminders (church_id, title, description, reminder_type, target_type, target_id, schedule_type, scheduled_at, recurring_rule, channels, is_active, created_by) VALUES
(1, 'Sunday Service Reminder', 'Weekly reminder for Sunday morning service', 'meeting', 'all', NULL, 'weekly', NULL, '{"days": [0], "time": "08:30"}', '["email", "sms"]', true, 1),
(1, 'Wednesday Prayer Meeting', 'Mid-week prayer and bible study', 'prayer', 'all', NULL, 'weekly', NULL, '{"days": [3], "time": "19:00"}', '["in_app", "push"]', true, 1),
(1, 'Monthly Fasting Reminder', 'Monthly fasting and prayer focus', 'prayer', 'all', NULL, 'monthly', NULL, '{"day": 1, "time": "06:00"}', '["email"]', true, 1),
(1, 'Youth Service Reminder', 'Weekly youth service for young adults', 'meeting', 'group', 1, 'weekly', NULL, '{"days": [6], "time": "18:00"}', '["sms", "push"]', true, 1),
(1, 'Foundation School Progress Reminder', 'Monthly reminder for foundation school students progress', 'education', 'role', 2, 'monthly', NULL, '{"day": 15, "time": "09:00"}', '["email", "in_app"]', true, 1),
(1, 'Follow-up Needed Reminder', 'Weekly reminder for members who haven''t been followed up in 30+ days', 'followup', 'role', 3, 'weekly', NULL, '{"days": [1], "time": "10:00"}', '["email", "sms"]', true, 1),
(1, 'Crisis Care Alert', 'Immediate notification for crisis situations requiring pastoral care', 'crisis', 'role', 4, 'immediate', NULL, '{}', '["email", "sms", "push"]', true, 1),
(1, 'Weekly Report Submission Reminder', 'Reminder for weekly report submission before deadline', 'report', 'role', 5, 'weekly', NULL, '{"days": [5], "time": "17:00"}', '["email", "in_app"]', true, 1),
(1, 'Monthly Ministry Report Reminder', 'End-of-month reminder for ministry reports', 'report', 'role', 6, 'monthly', NULL, '{"day": 28, "time": "16:00"}', '["email", "sms"]', true, 1),
(1, 'Foundation School Graduation Reminder', '6-month reminder for foundation school completion', 'education', 'role', 2, 'custom', NULL, '{"months": 6, "time": "09:00"}', '["email"]', true, 1),
(1, 'Inactive Member Follow-up', 'Monthly reminder to follow up with inactive members', 'followup', 'role', 3, 'monthly', NULL, '{"day": 10, "time": "11:00"}', '["email", "sms"]', true, 1);
  config JSONB,
  created_by INTEGER REFERENCES users(id) ON DELETE SET NULL,
  updated_at TIMESTAMP NOT NULL DEFAULT NOW()
);
