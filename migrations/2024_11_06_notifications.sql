...
-- Ensure church_id has a default value for existing records
UPDATE notification_templates SET church_id = 1 WHERE church_id IS NULL AND church_id IS NOT NULL;