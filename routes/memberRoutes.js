...
import {
  ...
  getCelebrationsCtrl,
  getOverviewCtrl,
  getMembersSummaryCtrl,
  getMembersGenderCtrl,
  getAgeDemographicsCtrl,
  getGrowthTrendCtrl,
  getUpcomingBirthdaysCtrl
} from '../controllers/memberController.js';
import { authenticateToken } from '../middleware/authMiddleware.js';
import { requirePermission } from '../middleware/rbacMiddleware.js';
import { getOverview } from '../models/overviewModel.js';
import {
  getRelationshipsCtrl,
  postRelationshipCtrl,
  deleteRelationshipCtrl,
  getMemberDepartmentsCtrl,
  assignDepartmentCtrl,
  removeDepartmentAssignmentCtrl,
  listDepartmentsCtrl,
  createDepartmentCtrl
} from '../controllers/memberRelationshipsController.js';
...
// Member Relationships & Departments
router.get('/:id/relationships', authenticateToken, requirePermission('view_members'), getRelationshipsCtrl);
router.post('/:id/relationships', authenticateToken, requirePermission('update_member'), express.json(), postRelationshipCtrl);
router.delete('/:id/relationships/:relId', authenticateToken, requirePermission('update_member'), deleteRelationshipCtrl);

// Departments & Assignments
router.get('/departments', authenticateToken, requirePermission('view_members'), listDepartmentsCtrl);
router.post('/departments', authenticateToken, requirePermission('create_member'), express.json(), createDepartmentCtrl);
router.get('/:id/departments', authenticateToken, requirePermission('view_members'), getMemberDepartmentsCtrl);
router.post('/:id/departments', authenticateToken, requirePermission('update_member'), express.json(), assignDepartmentCtrl);
router.delete('/:id/departments/:assignmentId', authenticateToken, requirePermission('update_member'), removeDepartmentAssignmentCtrl);

// Member Analytics Endpoints
router.get('/summary', authenticateToken, requirePermission('view_members'), getMembersSummaryCtrl);
router.get('/gender', authenticateToken, requirePermission('view_members'), getMembersGenderCtrl);
router.get('/ages', authenticateToken, requirePermission('view_members'), getAgeDemographicsCtrl);
router.get('/growth-trend', authenticateToken, requirePermission('view_members'), getGrowthTrendCtrl);
router.get('/upcoming-birthdays', authenticateToken, requirePermission('view_members'), getUpcomingBirthdaysCtrl);
