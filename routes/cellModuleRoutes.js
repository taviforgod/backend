...
import {
    ...
    getMyCellGroupCtrl, getMyAttendanceHistoryCtrl
...
// Place this BEFORE any '/:id' routes!
router.get('/my', authenticateToken, requirePermission('view_cell_group_member'), getMyCellGroupCtrl);
router.get('/my/attendance/history', authenticateToken, requirePermission('view_cell_group_member'), getMyAttendanceHistoryCtrl);
