...
export async function createTemplate({ church_id, name, channel, subject, body, description, variables, is_default, created_by }) {
  const res = await db.query(
    `INSERT INTO notification_templates
     (church_id, name, channel, subject, body, description, variables, is_default, created_by)
     VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)
     RETURNING *`,
    [church_id, name, channel, subject, body, description, JSON.stringify(variables || []), is_default || false, created_by]
  );
  return res.rows[0];
}
